...
public final class ASTNodeCreator {
    ...
    public Declaration createNamespaceDeclaration(String name, DeclarationType type, List<Variable> allFields, List<Method> allMethods, List<Modifier> topModifiers, List<Declaration> nestedDeclarations) {
    ...
    public Declaration createNestedDeclaration(String name, DeclarationType type, List<Variable> allFields, List<Method> allMethods, List<Modifier> modifiers) {
        return Declaration.newBuilder()
                .setName(name)
                .setType(type)
                .addAllModifiers(modifiers)
